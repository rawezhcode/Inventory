...
namespace Inventory
{
    public partial class frmTypeXarje : Form
    {
        Db db = new Db();
        public frmTypeXarje()
        {
        ...
        {
            DataGridView1.DataSource = db.query("SELECT id,name 'ناوی خەرجی' FROM type_xarje");
        ...
        private void frmTypeXarje_Load(object sender, EventArgs e)
        {
            showData();
        }
        ...
        private void btn_insert_Click(object sender, EventArgs e)
        {
            if (txt_naw.Text != "")
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    int insert = db.nQuery("INSERT INTO type_xarje (name) VALUES (@name)");
            ...
            try
            {
                if (txt_naw.Text != "")
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        int update = db.nQuery("update type_xarje set name = @name where id = @id");
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    int id = (int)DataGridView1.CurrentRow.Cells[0].Value;
                    int delete = db.nQuery("delete from type_xarje where id = @id", new string[] { "id", id.ToString() });
